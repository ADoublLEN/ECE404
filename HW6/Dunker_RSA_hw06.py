...
def main():
    if sys.argv[1] == '-e':
        public, private, p, q, eVAL = createKeys(e)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 4:
        print("Usage: \n\tEncrypt: ./Dunker_RSA_hw06.py -e message.txt output.txt\n\tDecrypt: ./Dunker_RSA_hw06.py -d output.txt decrypted.txt")
        sys.exit(1)
